...
export const useChatStore = create<ChatStore>((set, get) => ({
  ...
  updateMessage: (conversationId, messageId, updater) => set((state) => {
  ...
  deleteMessageFromStore: (conversationId, messageId) => set((state) => {
     const conv = state.conversations[conversationId];
    if (!conv) return {};
  ...
  setAbortController: (id, controller) => set((state) => {
